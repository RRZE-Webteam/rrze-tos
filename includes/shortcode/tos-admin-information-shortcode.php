		...
		if ( 200 === $status_code ) {
			...
			if($values) {
				...
				foreach($values as $key => $value) {
					$store['verantwortlich']['strasse']   =  $values['rrze_tos_field_6'];
					$store['verantwortlich']['ort']       =  $values['rrze_tos_field_7'];
					$store['verantwortlich']['telefon']   =  $values['rrze_tos_field_8'];
					#$store['verantwortlich']['email']     =  $values['rrze_tos_field_9'];
					#$store['verantwortlich']['personid']  =  $values['rrze_tos_field_10'];
					$store['webmaster']['strasse']   =  $values['rrze_tos_field_13'];
					$store['webmaster']['ort']       =  $values['rrze_tos_field_14'];
					$store['webmaster']['telefon']   =  $values['rrze_tos_field_15'];
					#$store['webmaster']['email']     =  $values['rrze_tos_field_16'];
					#$store['webmaster']['personid']  =  $values['rrze_tos_field_17'];
				}
			...
			foreach($values as $key => $value) {
				$store['verantwortlich']['vorname']   =  $values['rrze_tos_field_4'];
				$store['verantwortlich']['nachname']  =  $values['rrze_tos_field_5'];
				$store['verantwortlich']['strasse']   =  $values['rrze_tos_field_6'];
				$store['verantwortlich']['ort']       =  $values['rrze_tos_field_7'];
				$store['verantwortlich']['telefon']   =  $values['rrze_tos_field_8'];
				$store['verantwortlich']['email']     =  $values['rrze_tos_field_9'];
				#$store['verantwortlich']['personid']  =  $values['rrze_tos_field_10'];
				$store['webmaster']['vorname']   =  $values['rrze_tos_field_11'];
				$store['webmaster']['nachname']  =  $values['rrze_tos_field_12'];
				$store['webmaster']['strasse']   =  $values['rrze_tos_field_13'];
				$store['webmaster']['ort']       =  $values['rrze_tos_field_14'];
				$store['webmaster']['telefon']   =  $values['rrze_tos_field_15'];
				$store['webmaster']['email']     =  $values['rrze_tos_field_16'];
