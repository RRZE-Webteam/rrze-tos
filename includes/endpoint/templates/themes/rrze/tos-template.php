...
<div id="primary" class="content-area">
	<div id="content" class="site-content" role="main">
		...
		<p>Bei Problemen mit der Bedienung der Webseite schreiben Sie eine E-Mail an <a
				href="mailto:<?php echo $values['rrze_tos_webmaster_email'] ?>?subject=<?php echo( ! empty( $values['rrze_tos_subject'] ) ? $values['rrze_tos_subject'] : 'Feedback zur Barrierefreiheit des Webauftritts' ) ?>"><?php echo $values['rrze_tos_webmaster_email'] ?></a>
		...
		<p class="complaint">Sollten Sie den Eindruck haben, dass Ihnen nicht geholfen wird, können Sie sich an die <a
				href="https://www.behindertenbeauftragte.de/DE/SchlichtungsstelleBGG/SchlichtungsstelleBGG_node.html">Schiedsstelle</a>
			wenden.
		<p>
	</div>
</div>
