...
get_header(); ?>
    ...
    <section id="hero" class="hero-small">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h1><?php echo (isset($values['rrze_tos_field_1']) ? $values['rrze_tos_field_1'] : 'Barrierefreiheitserklärung') ?></h1>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <main>                        
                        ...
                        <?php  
                            ...
                            <?php } else { ?>
                                ...
                                <p style="margin-top:20px;margin-bottom:20px"><strong><?php _e('Reason:','rrze-tos') ?></strong></p>
                               ...
                               <?php } ?>
                                ...
                                <p>
                                    <?php _e('If you have any problems using this website, please write an email to ','rrze-tos') ?><a href="mailto:<?php echo $values['rrze_tos_field_16'] ?>?subject=<?php echo (!empty($values['rrze_tos_field_19']) ? $values['rrze_tos_field_19'] : 'Feedback zur Barrierefreiheit des Webauftritts') ?>"><?php echo $values['rrze_tos_field_16'] ?></a><?php _e(' or fill out the feedback form!', 'rrze-tos') ?>
                                </p>
                        ...
                        <?php echo do_shortcode('[contact field-one="name,text,name-id,rrze-name" '
                                ...
                                . 'field-six="timeout,hidden,timeout-id"]'); ?>
                                 <p class="complaint"><?php _e('If you feel that you are not being helped, you can contact the ','rrze-tos') ?><a href="https://www.behindertenbeauftragte.de/DE/SchlichtungsstelleBGG/SchlichtungsstelleBGG_node.html"> <?php _e('arbitration board.','rrze-tos') ?> </a><p>
